<?php 
  ...
  session_start();
  define("APPURL", "http://localhost/aerovibetravels");

  
  //images dirs
  define("COUNTRIESIMAGES", "http://localhost/aerovibetravels/admin-panel/countries-admins/images_countries");
  define("CITIESIMAGES", "http://localhost/aerovibetravels/admin-panel/cities-admins/images_cities");
...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo APPURL; ?>/assets/css/aerovibe-travels.css">
...
Copyright (c) 2026 AeroVibe Travels. All Rights Reserved.
